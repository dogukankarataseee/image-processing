...
# resim oluştur
img = np.zeros((512,512,3), np.uint8) # 512x512 Siyah bir resim oluşturulur.
print(img.shape)

cv2.imshow("Siyah Resim", img) # Sadece siyah resim

# çizgi
#      (resim, başlangıç noktası, bitiş noktası, renk, kalınlık)
cv2.line(img, (100,100), (100,300), (0,255,0), 3) # yeşil BGR = (0,255,0)
...
cv2.putText(img, "Resim", (350,350), cv2.FONT_HERSHEY_COMPLEX, 3, (0,0,255))
